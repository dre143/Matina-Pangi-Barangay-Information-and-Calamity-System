    ...
    <nav class="navbar navbar-expand-lg navbar-custom sticky-top">
        <div class="container">
            <a class="navbar-brand" href="#">
                <img src="<?php echo e(asset('logo.png')); ?>" alt="Logo" onerror="this.style.display='none'">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 hero-content text-center text-lg-start">
                    ...
                    <div class="hero-buttons">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-hero btn-hero-primary">
                            <i class="bi bi-box-arrow-in-right me-2"></i>Login
                        </a>
                ...
                <div class="col-lg-6 hero-image text-center mt-5 mt-lg-0">
                    <img src="<?php echo e(asset('pangi.png')); ?>" alt="Barangay Matina Pangi" style="max-width: 500px; width: 100%;" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-md-3 col-6">
                    <div class="stat-item">
                        ...
                        <div class="stat-number"><?php echo e(\App\Models\Resident::where('approval_status', 'approved')->count()); ?></div>
                ...
                <div class="col-md-3 col-6">
                    <div class="stat-item">
                        ...
                        <div class="stat-number"><?php echo e(\App\Models\Household::where('approval_status', 'approved')->count()); ?></div>
                ...
                <div class="col-md-3 col-6">
                    <div class="stat-item">
                        ...
                        <div class="stat-number"><?php echo e(\App\Models\Resident::where('approval_status', 'approved')->where('is_senior_citizen', true)->count()); ?></div>
                ...
                <div class="col-md-3 col-6">
                    <div class="stat-item">
                        ...
                        <div class="stat-number"><?php echo e(\App\Models\Resident::where('approval_status', 'approved')->where('is_voter', true)->count()); ?></div>
                ...
                <div class="col-md-4">
                    <div class="card news-card">
                        <div class="card-body">
                            ...
                            <p class="news-date mt-2"><i class="bi bi-calendar3 me-2"></i><?php echo e(now()->format('F d, Y')); ?></p>
...
<?php /**PATH C:\xampp\htdocs\pangi\resources\views/welcome-enhanced.blade.php ENDPATH**/ ?>