<?php $__env->startSection('title', 'Dashboard - Barangay Matina Pangi'); ?>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        ...
                        <h2 class="stat-value mb-0"><?php echo e(number_format($stats['total_residents'])); ?></h2>
                    </div>
                    <div class="stat-icon">
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        ...
                        <h2 class="stat-value mb-0"><?php echo e(number_format($stats['total_households'])); ?></h2>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        ...
                        <h2 class="stat-value mb-0"><?php echo e(number_format($stats['total_senior_citizens'])); ?></h2>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        ...
                        <h2 class="stat-value mb-0"><?php echo e(number_format($stats['total_pwd'])); ?></h2>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        ...
                        <h2 class="stat-value mb-0"><?php echo e(number_format($stats['total_teens'])); ?></h2>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        ...
                        <h2 class="stat-value mb-0"><?php echo e(number_format($stats['total_voters'])); ?></h2>
                    </div>
                    <div class="stat-icon">
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        ...
                        <h2 class="stat-value mb-0"><?php echo e(number_format($stats['total_4ps'])); ?></h2>
                    </div>
            ...
            <div class="card-body p-4">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    <div>
                        ...
                        <h2 class="stat-value mb-0"><?php echo e(number_format($stats['average_household_size'], 1)); ?></h2>
                    </div>
            ...
            <div class="card-body">
                <div class="mb-4">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <strong class="text-primary"><?php echo e(number_format($stats['male_count'])); ?></strong>
                    </div>
                    <div class="progress" style="height: 12px; border-radius: 10px;">
                        <div class="progress-bar" style="width: <?php echo e($stats['total_residents'] > 0 ? ($stats['male_count'] / $stats['total_residents'] * 100) : 0); ?>%; background: linear-gradient(90deg, #3b82f6, #2563eb);"></div>
                    </div>
                    <small class="text-muted"><?php echo e($stats['total_residents'] > 0 ? number_format(($stats['male_count'] / $stats['total_residents'] * 100), 1) : 0); ?>%</small>
                </div>
                <div>
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <div class="d-flex align-items-center">
                        ...
                        <strong class="text-danger"><?php echo e(number_format($stats['female_count'])); ?></strong>
                    </div>
                    <div class="progress" style="height: 12px; border-radius: 10px;">
                        <div class="progress-bar" style="width: <?php echo e($stats['total_residents'] > 0 ? ($stats['female_count'] / $stats['total_residents'] * 100) : 0); ?>%; background: linear-gradient(90deg, #ef4444, #dc2626);"></div>
                    </div>
                    <small class="text-muted"><?php echo e($stats['total_residents'] > 0 ? number_format(($stats['female_count'] / $stats['total_residents'] * 100), 1) : 0); ?>%</small>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card-body">
                <div class="d-flex flex-column gap-3">
                    <div class="d-flex justify-content-between align-items-center p-2 rounded" style="background: rgba(16, 185, 129, 0.05);">
                        ...
                        <strong><?php echo e(number_format($ageDistribution['children'])); ?></strong>
                    </div>
                    <div class="d-flex justify-content-between align-items-center p-2 rounded" style="background: rgba(139, 92, 246, 0.05);">
                        ...
                        <strong><?php echo e(number_format($ageDistribution['teens'])); ?></strong>
                    </div>
                    <div class="d-flex justify-content-between align-items-center p-2 rounded" style="background: rgba(59, 130, 246, 0.05);">
                        ...
                        <strong><?php echo e(number_format($ageDistribution['adults'])); ?></strong>
                    </div>
                    <div class="d-flex justify-content-between align-items-center p-2 rounded" style="background: rgba(245, 158, 11, 0.05);">
                        ...
                        <strong><?php echo e(number_format($ageDistribution['seniors'])); ?></strong>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex flex-column gap-3">
                    <?php if(auth()->user()->isSecretary()): ?>
                        <a href="<?php echo e(route('households.create')); ?>" class="btn btn-gradient d-flex align-items-center justify-content-center gap-2">
                            <i class="bi bi-plus-circle-fill"></i>
                            <span>Register Household</span>
                        </a>
                        <a href="<?php echo e(route('households.index')); ?>" class="btn btn-outline-primary d-flex align-items-center justify-content-center gap-2">
                            <i class="bi bi-person-plus-fill"></i>
                            <span>Add Resident</span>
                        </a>
                        <a href="<?php echo e(route('certificates.create')); ?>" class="btn btn-outline-success d-flex align-items-center justify-content-center gap-2">
                            <i class="bi bi-file-earmark-text-fill"></i>
                            <span>Issue Certificate</span>
                        </a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('census.index')); ?>" class="btn btn-outline-success d-flex align-items-center justify-content-center gap-2">
    ...
    <div class="col-12">
        <div class="card border-0">
            <div class="card-header bg-gradient d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('residents.index')); ?>" class="btn btn-sm btn-light">
                ...
                <div class="table-responsive">
                    <table class="table table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <span class="badge bg-light text-dark"><?php echo e($resident->resident_id); ?></span>
                                </td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="<?php echo e(route('residents.show', $resident)); ?>" class="text-decoration-none fw-semibold">
                                            <?php echo e($resident->full_name); ?>

                                        </a>
                                    </div>
                                </td>
                                <td><?php echo e($resident->age); ?> yrs</td>
                                <td>
                                    <?php if($resident->sex == 'male'): ?>
                                ...
                                <td>
                                    <a href="<?php echo e(route('households.show', $resident->household)); ?>" class="text-decoration-none">
                                        <i class="bi bi-house-fill text-success"></i> <?php echo e($resident->household->household_id); ?>

                                    </a>
                                </td>
                                <td>
                                    <small class="text-muted">
                                        <i class="bi bi-clock"></i> <?php echo e($resident->created_at->diffForHumans()); ?>

                                    </small>
                                </td>
                                <td>
                                    <a href="<?php echo e(route('residents.show', $resident)); ?>" class="btn btn-sm btn-outline-primary">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pangi\resources\views/dashboard.blade.php ENDPATH**/ ?>