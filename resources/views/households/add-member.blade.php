        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <p><strong>Head:</strong> {{ $household->officialHead ? $household->officialHead->full_name : 'N/A' }}</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <form action="{{ route('households.store-member', $household) }}" method="POST">
                ...
                <div class="row g-3">
                            ...
                            <div class="card-body">
                                ...
                                <select name="sub_family_id" class="form-select form-select-lg" required>
                                    ...
                                    @if($primaryFamily && $primaryFamily->subHead)
                                        <option value="{{ $primaryFamily->id }}" class="fw-bold" {{ old('sub_family_id') == $primaryFamily->id ? 'selected' : '' }}>
                                    ...
                                    @foreach($extendedFamilies as $family)
                                        @if($family->subHead)
                                            <option value="{{ $family->id }}" {{ old('sub_family_id') == $family->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-1">
                        ...
                        <input type="text" name="suffix" class="form-control" placeholder="Jr., Sr." value="{{ old('suffix') }}">
                    </div>
                    
                    <div class="col-md-3">
                        <label class="form-label">Birthdate <span class="text-danger">*</span></label>
                        <input type="date" name="birthdate" id="birthdate" class="form-control" required value="{{ old('birthdate') }}">
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="household_role" class="form-select" required>
                            <option value="">Select</option>
                            <option value="spouse" {{ old('household_role') == 'spouse' ? 'selected' : '' }}>Spouse</option>
                            <option value="child" {{ old('household_role') == 'child' ? 'selected' : '' }}>Child</option>
                            <option value="parent" {{ old('household_role') == 'parent' ? 'selected' : '' }}>Parent</option>
                            <option value="sibling" {{ old('household_role') == 'sibling' ? 'selected' : '' }}>Sibling</option>
                            <option value="relative" {{ old('household_role') == 'relative' ? 'selected' : '' }}>Relative</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="nationality" class="form-control" value="{{ old('nationality', 'Filipino') }}">
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="monthly_income" class="form-control" step="0.01" min="0" value="{{ old('monthly_income') }}">
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-check mb-2">
                            <input type="checkbox" name="is_pwd" class="form-check-input" id="is_pwd" value="1" {{ old('is_pwd') ? 'checked' : '' }}>
                            <label class="form-check-label fw-bold" for="is_pwd">Person with Disability (PWD)</label>
                        </div>
                        <input type="text" name="pwd_id" id="pwd_id_input" class="form-control" placeholder="PWD ID Number" value="{{ old('pwd_id') }}" disabled>
                        <input type="text" name="disability_type" id="disability_type_input" class="form-control mt-2" placeholder="Type of Disability" value="{{ old('disability_type') }}" disabled>
                    </div>
                    
                    <div class="col-md-4">
                        <div class="form-check mb-2">
                            <input type="checkbox" name="is_4ps_beneficiary" class="form-check-input" id="is_4ps" value="1" {{ old('is_4ps_beneficiary') ? 'checked' : '' }}>
                            <label class="form-check-label fw-bold" for="is_4ps">4Ps Beneficiary</label>
                        </div>
                        <input type="text" name="4ps_id" id="4ps_id_input" class="form-control" placeholder="4Ps ID Number" value="{{ old('4ps_id') }}" disabled>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="precinct_number" id="precinct_input" class="form-control" placeholder="Precinct Number (if registered)" value="{{ old('precinct_number') }}" disabled>
